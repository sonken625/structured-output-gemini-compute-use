...
class PlaywrightComputer:
    ...
    Args:
        screen_size: The viewport size (width, height) to use.
        initial_url: The initial URL to open when starting the browser.

        search_engine_url: The URL of the search engine to use for "search" actions.
        highlight_mouse: Whether to visually highlight the mouse cursor on the screen.
        remote_debugging_port: If provided, connects to an existing Playwright instance
            via the given remote debugging port.
        close_on_exit: Whether to close the browser when exiting the context.
        headless: Whether to run the browser in headless mode.(if remote_debugging_port is set, this is ignored)
    """
